...
class VoiceModel {
  ...
  bool get isGoogleFallback => id.contains('GoogleTranslate');
  bool get isElevenLabs => id.startsWith('elevenlabs:');
  bool get supportsPitch => !isGoogleFallback && !isElevenLabs;

  String get providerLabel {
    if (isGoogleFallback) return 'Google';
    if (isElevenLabs) return 'ElevenLabs';
    return 'Edge';
  }
  ...
  static const List<VoiceModel> _edgeTtsVoices = [
    ...
    VoiceModel(
      id: 'vi-VN-GoogleTranslate',
      name: 'Google Viet',
      gender: 'neutral',
      language: 'vi-VN',
    ),
    VoiceModel(
      id: 'elevenlabs:JxmKvRaNYFidf0N27Vng',
      name: 'Sơn Trần',
      gender: 'male',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:9EE00wK5qV6tPtpQIxvy',
      name: 'Tuấn TLU',
      gender: 'male',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:faGOoglJYMOx2d1ya5l9',
      name: 'Darian',
      gender: 'male',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:5vqV9IG7sDpzgzKOIZAv',
      name: 'Kênh',
      gender: 'male',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:foH7s9fX31wFFH2yqrFa',
      name: 'Huyền',
      gender: 'female',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:a3AkyqGG4v8Pg7SWQ0Y3',
      name: 'Ngân',
      gender: 'female',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:qByVAGjXwGlkcRDJoiHg',
      name: 'Kiều Linh',
      gender: 'female',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:A5w1fw5x0uXded1LDvZp',
      name: 'Như',
      gender: 'female',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:d5HVupAWCwe4e6GvMCAL',
      name: 'Mai',
      gender: 'female',
      language: 'vi-VN',
      isPremium: true,
    ...
    VoiceModel(
      id: 'elevenlabs:DvG3I1kDzdBY3u4EzYh6',
      name: 'Nguyễn Ngân',
      gender: 'female',
      language: 'vi-VN',
      isPremium: true,
